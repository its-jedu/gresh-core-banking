...
SELECT id, '1000000001','savings','active',0 FROM customers WHERE email='jane@example.com'
UNION ALL
SELECT id, '1000000002','current','active',0 FROM customers WHERE email='john@example.com'
ON CONFLICT DO NOTHING;
